          ...
          <div style={{
            ...
            {showSpotify && (
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0.6rem 0.9rem 0.3rem" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    ...
                    <span style={{ fontFamily: "Jost, sans-serif", fontWeight: 300, fontSize: "0.42rem", letterSpacing: "0.22em", textTransform: "uppercase", color: "rgba(30,215,96,0.75)" }}>Playlist ALBA</span>
                  </div>
                  <button onClick={() => setShowSpotify(false)} style={{ background: "none", border: "none", color: "rgba(255,255,255,0.25)", cursor: "pointer", fontSize: "1.1rem", lineHeight: 1, padding: "0 0.2rem" }}>×</button>
                </div>
                <iframe
            ...
            <button
              ...
              style={{
                ...
                background: showSpotify ? "rgba(30,215,96,0.18)" : "rgba(13,10,18,0.88)",
                border: `1px solid rgba(30,215,96,${showSpotify ? "0.55" : "0.28"})`,
                borderRadius: "20px",
            ...
            >
              ...
              <span style={{ fontFamily: "Jost, sans-serif", fontWeight: 300, fontSize: "0.44rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(30,215,96,0.85)" }}>
                ♪
              </span>
            </button>
          </div>

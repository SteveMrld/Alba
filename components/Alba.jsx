            ...
            <div style={{ minWidth: 60, textAlign: "right", display: "flex", alignItems: "center", justifyContent: "flex-end", gap: "0.6rem" }}>
              ...
              <div style={{ position: "relative" }}>
                <button onClick={() => setShowSpotify(s => !s)} style={{
                  background: showSpotify ? "rgba(30,215,96,0.15)" : "none",
                  border: `1px solid rgba(30,215,96,${showSpotify ? "0.5" : "0.25"})`,
                  borderRadius: "50%", width: 22, height: 22,
                  display: "flex", alignItems: "center", justifyContent: "center",
                  cursor: "pointer", transition: "all 0.2s", padding: 0,
                  WebkitTapHighlightColor: "transparent",
                }}>
                  <svg width={11} height={11} viewBox="0 0 24 24" fill="#1ED760">

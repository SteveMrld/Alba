...
const Evasion = ({ data, isPremium = false, onShowPaywall, onShowLataif, onShowThemes }) => {
  ...
  return (
    ...
    >
      {/* Bouton Spotify + embed */}
      {showSpotify && (
        <div style={{
          position: "absolute", bottom: 160, left: "50%", transform: "translateX(-50%)",
          zIndex: 21, width: "min(340px, calc(100vw - 2rem))",
          background: "rgba(10,8,6,0.92)", border: "1px solid rgba(30,215,96,0.25)",
          borderRadius: "14px", overflow: "hidden", backdropFilter: "blur(16px)",
        }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0.7rem 1rem 0.4rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
              ...
              <span style={{ fontFamily: "Jost, sans-serif", fontWeight: 300, fontSize: "0.45rem", letterSpacing: "0.25em", textTransform: "uppercase", color: "rgba(30,215,96,0.8)" }}>Playlist ALBA</span>
            </div>
            <button onClick={() => setShowSpotify(false)} style={{ background: "none", border: "none", color: "rgba(255,255,255,0.3)", cursor: "pointer", fontSize: "1rem", padding: "0.2rem 0.4rem", lineHeight: 1 }}>×</button>
          </div>
          <iframe
      ...
      <div style={{ position: "absolute", bottom: 118, left: "50%", transform: "translateX(-50%)", zIndex: 20 }}>
        <button onClick={() => setShowSpotify(s => !s)} style={{
          display: "flex", alignItems: "center", gap: "0.6rem",
          background: showSpotify ? "rgba(30,215,96,0.15)" : "rgba(10,8,6,0.75)",
          border: `1px solid rgba(30,215,96,${showSpotify ? "0.6" : "0.35"})`,
          borderRadius: "30px", padding: "0.55rem 1.3rem",
